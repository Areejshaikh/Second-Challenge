...
let famous_person :string = ("Albert Einstein Said");
let message : string = (`${famous_person}“A person who never made a mistake never tried  anything new.”`);
console.log(message);


// Question 3: Stripping Names: Store a person’s name, and include some 
// whitespace characters at the beginning and end of the name. Use "\t" (tab) 
// and "\n" (new line) at least once. Print the name once, so the whitespace 
// around the name is displayed. Then print the name after stripping the white 
// spaces.
